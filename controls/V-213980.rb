...
control 'V-213980' do
  title "Use of credentials and proxies must be restricted to necessary cases
only."
...
C.credential_identity
    ...
    If any Credentials or SQL Agent Proxy accounts are returned that are not
documented and authorized, this is a finding.
  "
  desc  'fix', "
    Remove any SQL Agent Proxy accounts and credentials that are not
authorized.
  ...
  tag gid: 'V-213980'
  tag rid: 'SV-213980r508026_rule'
  tag stig_id: 'SQL6-D0-010500'
  tag fix_id: 'F-15195r313724_fix'
  tag cci: ['SV-93927', 'V-79221', 'CCI-002233']
  tag nist: ['AC-6 (8)']
end
