...
necessarily imply authorization to access SQL Server.  To mitigate the risk of
...
a category that includes database management systems.  If SQL Server does not
...
a finding.
    ...
    Use the supplemental file \"Instance permissions assignments to logins and
roles.sql.\"
  "
  desc  'fix', "Use GRANT, REVOKE, DENY, ALTER SERVER ROLE … ADD MEMBER …
and/or ALTER SERVER ROLE …. DROP MEMBER statements to add and remove
permissions on server-level securables, bringing them into line with the
documented requirements."
  impact 0.7
  tag severity: 'high'
  tag gtitle: 'SRG-APP-000033-DB-000084'
  tag gid: 'V-213932'
  tag rid: 'SV-213932r508026_rule'
