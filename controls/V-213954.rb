...
developed to prevent vulnerabilities from being introduced to SQL Server and
host system.
  "
  desc  'rationale', ''
  desc  'check', "
    Review the server documentation, if this system is identified as a
development or test system, this check is Not Applicable.
...
database names:
  ...
  "
  desc  'fix', "Remove all demonstration or sample databases from production
instances."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000141-DB-000090'
  tag gid: 'V-213954'
  tag rid: 'SV-213954r508026_rule'
  tag stig_id: 'SQL6-D0-006900'
  tag fix_id: 'F-15169r313646_fix'
  tag cci: ['V-79171', 'SV-93877', 'CCI-000381']
  tag nist: ['CM-7 a']
end
