...
audit when data classifications are unsuccessfully retrieved.
...
unsuccessfully retrieved. See the supplemental file \"SQL 2016 Audit.sql\"."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000494-DB-000345'
  tag gid: 'V-213998'
  tag rid: 'SV-213998r508026_rule'
  tag stig_id: 'SQL6-D0-013200'
  tag fix_id: 'F-15213r313778_fix'
  tag cci: ['SV-93963', 'V-79257', 'CCI-000172']
  tag nist: ['AU-12 c']
end
