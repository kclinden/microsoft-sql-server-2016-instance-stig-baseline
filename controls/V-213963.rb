...
accountability of individual activity.
  ...
  desc  'rationale', ''
  desc  'check', "
    Review SQL Server users to determine whether shared accounts exist. (This
does not include the case where SQL Server has a guest or public account that
is providing access to publicly available information.)
...
relevant circumstances.
  ...
  tag gid: 'V-213963'
  tag rid: 'SV-213963r508026_rule'
  tag stig_id: 'SQL6-D0-007800'
  tag fix_id: 'F-15178r313673_fix'
  tag cci: ['V-79189', 'SV-93895', 'CCI-000764']
  tag nist: ['IA-2']
end
