...
the access to audit tools.  SQL Server is an application that does provide
...
permissions ALTER ANY SERVER AUDIT, ALTER ANY DATABASE AUDIT, CONTROL SERVER,
ALTER TRACE:
...
'ALTER ANY SERVER AUDIT','ALTER TRACE')
...
to have them.
  ...
  tag gid: 'V-213947'
  tag rid: 'SV-213947r508026_rule'
  tag stig_id: 'SQL6-D0-006200'
  tag fix_id: 'F-15162r313625_fix'
  tag cci: ['V-79157', 'SV-93863', 'CCI-001493']
  tag nist: ['AU-9']
end
