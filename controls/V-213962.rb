...
organization-defined ports, as defined in the PPSM CAL and vulnerability
assessments."
...
unnecessary physical and logical ports on information systems.
...
essential capabilities and limiting the use of ports to only those required,
authorized, and approved to conduct official business or to address authorized
quality of life issues.

    SQL Server using ports deemed unsafe is open to attack through those ports.
...
other components of the information system.
  ...
  desc  'check', "
    ...
    To determine whether SQL Server is configured to use a fixed port or
dynamic ports, in the right-hand pane double-click on the TCP/IP entry, to open
the Properties dialog. (The default fixed port is 1433.)

    If these are in conflict with PPSM guidance, and not explained and approved
in the system documentation, this is a finding.
  "
  desc  'fix', "Use SQL Server Configuration to change the ports used by SQL
Server to comply with PPSM guidance, or document the need for other ports, and
obtain written approval. Close ports no longer needed."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000142-DB-000094'
  tag gid: 'V-213962'
  tag rid: 'SV-213962r508026_rule'
  tag stig_id: 'SQL6-D0-007700'
  tag fix_id: 'F-15177r313670_fix'
  tag cci: ['V-79187', 'SV-93893', 'CCI-000382']
  tag nist: ['CM-7 b']
end
