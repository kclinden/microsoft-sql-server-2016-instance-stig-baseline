...
maintained at every step of the data transfer and handling process.
    ...
    SQL Server Service Broker endpoints support different encryption
algorithms, including no-encryption. Using a weak encryption algorithm or
plaintext in communication protocols can lead to data loss, data manipulation
and/or connection hijacking.
  "
  desc  'rationale', ''
  desc  'check', "
...
and handling process, and the requirement is documented and authorized, this is
not a finding.

    If SQL Service Broker is in use, run the following to check for encrypted
transmissions:  
  ...
  tag gid: 'V-214032'
  tag rid: 'SV-214032r508026_rule'
  tag stig_id: 'SQL6-D0-016600'
  tag fix_id: 'F-15247r313880_fix'
  tag cci: ['SV-94031', 'V-79325', 'CCI-000366']
  tag nist: ['CM-6 b']
end
