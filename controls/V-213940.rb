...
session auditing is in use, it needs to be in operation for the whole time SQL
Server is running."
  desc  'rationale', ''
  desc  'check', "
...
no audits are returned, this is a finding.
  ...
  desc  'fix', "
    ...
    Ensure the SQL STIG Audit is configured to initiate session auditing upon
startup.
  "
  impact 0.5
  tag severity: 'medium'
  ...
  tag gid: 'V-213940'
  tag rid: 'SV-213940r508026_rule'
  tag stig_id: 'SQL6-D0-004700'
  tag fix_id: 'F-15155r313604_fix'
  tag cci: ['SV-93847', 'V-79141', 'CCI-001464']
  tag nist: ['AU-14 (1)']
end
