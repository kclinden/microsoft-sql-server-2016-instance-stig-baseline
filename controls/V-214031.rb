...
maintained at every step of the data transfer and handling process.
    ...
    SQL Mirroring endpoints support different encryption algorithms, including
no-encryption. Using a weak encryption algorithm or plaintext in communication
protocols can lead to data loss, data manipulation and/or connection hijacking.
  "
  desc  'rationale', ''
  desc  'check', "
...
not a finding.
    ...
    If Database Mirroring is in use, run the following to check for encrypted
transmissions:  
  ...
  tag gid: 'V-214031'
  tag rid: 'SV-214031r508026_rule'
  tag stig_id: 'SQL6-D0-016500'
  tag fix_id: 'F-15246r313877_fix'
  tag cci: ['SV-94029', 'V-79323', 'CCI-000366']
  tag nist: ['CM-6 b']
end
