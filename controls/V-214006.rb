...
audit when data classifications are unsuccessfully modified.
...
unsuccessfully modified. See the supplemental file \"SQL 2016 Audit.sql\"."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000498-DB-000347'
  tag gid: 'V-214006'
  tag rid: 'SV-214006r508026_rule'
  tag stig_id: 'SQL6-D0-014000'
  tag fix_id: 'F-15221r313802_fix'
  tag cci: ['V-79273', 'SV-93979', 'CCI-000172']
  tag nist: ['AU-12 c']
end
