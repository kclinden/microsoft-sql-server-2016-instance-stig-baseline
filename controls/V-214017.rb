...
control 'V-214017' do
  title "SQL Server must generate audit records showing starting and ending
time for user access to the database(s)."
  desc  "For completeness of forensic analysis, it is necessary to know how
long a user's (or other principal's) connection to SQL Server lasts. This can
...
query:
    ...
    Execute the following query to verify the following events are included in
...
(STATE = ON);
  ...
  tag gid: 'V-214017'
  tag rid: 'SV-214017r508026_rule'
  tag stig_id: 'SQL6-D0-015100'
  tag fix_id: 'F-15232r313835_fix'
  tag cci: ['V-79295', 'SV-94001', 'CCI-000172']
  tag nist: ['AU-12 c']
end
