...
control 'V-214019' do
  title "SQL Server must generate audit records when successful accesses to
objects occur."
...
audit when successful accesses to objects occur.
