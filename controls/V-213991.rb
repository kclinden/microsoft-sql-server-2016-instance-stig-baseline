...
control 'V-213991' do
  title "SQL Server must maintain a separate execution domain for each
executing process."
...
modify the executing code of another process.
    ...
    Maintaining separate execution domains for executing processes can be
achieved, for example, by implementing separate address spaces.
  "
  desc  'rationale', ''
  desc  'check', "
    Review the server documentation to determine whether use of CLR assemblies
is required. Run the following query to determine whether CLR is enabled for
the instance:
  ...
  tag gid: 'V-213991'
  tag rid: 'SV-213991r508026_rule'
  tag stig_id: 'SQL6-D0-012300'
  tag fix_id: 'F-15206r313757_fix'
  tag cci: ['SV-93949', 'V-79243', 'CCI-002530']
  tag nist: ['SC-39']
end
