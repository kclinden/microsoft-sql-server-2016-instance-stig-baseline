...
only essential capabilities.
    ...
    Unused, unnecessary DBMS components increase the attack vector for SQL
Server by introducing additional targets for attack. By minimizing the services
...
report\"
    ...
    Compare the feature listing against the required components listing. Note
any components that are installed, but not required.

    Launch SQL Server Configuration Manager.

    If any components that are installed but are not required are not disabled,
this is a finding.
...
uninstalled."
  ...
  tag gid: 'V-213956'
  tag rid: 'SV-213956r508026_rule'
  tag stig_id: 'SQL6-D0-007100'
  tag fix_id: 'F-15171r313652_fix'
  tag cci: ['SV-93881', 'V-79175', 'CCI-000381']
  tag nist: ['CM-7 a']
end
