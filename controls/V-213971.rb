...
control 'V-213971' do
  title "SQL Server must maintain the authenticity of communications sessions
...
demonstrated to be effective.
  ...
  desc  'rationale', ''
  desc  'check', "
    Verify that Windows is configured to require the use of FIPS compliant
algorithms.
...
signing.\" >> Change the Setting option to \"Enabled\" >> Restart Windows
  ...
  tag gid: 'V-213971'
  tag rid: 'SV-213971r508026_rule'
  tag stig_id: 'SQL6-D0-009200'
  tag fix_id: 'F-15186r313697_fix'
  tag cci: ['V-79203', 'SV-93909', 'CCI-001188']
  tag nist: ['SC-23 (3)']
end
