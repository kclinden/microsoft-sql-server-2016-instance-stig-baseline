...
control 'V-214018' do
  title "SQL Server must generate audit records when concurrent
...
query.
    ...
    Execute the following query to verify the \"SUCCESSFUL_LOGIN_GROUP\" is
...
'SUCCESSFUL_LOGIN_GROUP'
    ...
    If the \"SUCCESSFUL_LOGIN_GROUP\" is returned in an active audit, this is
not a finding.

    If \"SUCCESSFUL_LOGIN_GROUP\" is not in the active audit, determine whether
\"Both failed and successful logins\" is enabled.

    In SQL Management Studio:
    Right-click on the instance >> Select \"Properties\" >> Select \"Security\"
on the left hand side >> Check the setting for \"Login auditing\"
...
(STATE = ON);
    ...
    In SQL Management Studio:
    Right-click on the instance >> Select \"Properties\" >> Select \"Security\"
on the left hand side >> Select \"Both failed and successful logins\" >> Click
\"OK\"
  "
  impact 0.5
  tag severity: 'medium'
  ...
  tag gid: 'V-214018'
  tag rid: 'SV-214018r508026_rule'
  tag stig_id: 'SQL6-D0-015200'
  tag fix_id: 'F-15233r313838_fix'
  tag cci: ['V-79297', 'SV-94003', 'CCI-000172']
  tag nist: ['AU-12 c']
end
