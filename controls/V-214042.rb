...
control 'V-214042' do
  title "The SQL Server Browser service must be disabled unless specifically
...
a list of running SQL Server instances.
  "
  desc  'rationale', ''
  desc  'check', "
    If the need for the SQL Server Browser service is documented and
authorized, this is not a finding.
...
appropriate authorization.
    ...
    Where SQL Server Browser is judged unnecessary, the Service can be
disabled.

    To disable, in the Services tool, double-click \"SQL Server Browser\". Set
\"Startup Type\" to \"Disabled\". If \"Service Status\" is \"Running\", click
on \"Stop\". Click on \"OK\".
  "
  impact 0.3
  tag severity: 'low'
  ...
  tag gid: 'V-214042'
  tag rid: 'SV-214042r508026_rule'
  tag stig_id: 'SQL6-D0-017800'
  tag fix_id: 'F-15257r313910_fix'
  tag cci: ['SV-94055', 'V-79349', 'CCI-000366']
  tag nist: ['CM-6 b']
end
