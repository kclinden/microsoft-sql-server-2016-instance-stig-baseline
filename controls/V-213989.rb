...
control 'V-213989' do
  title "SQL Server must produce audit records of its enforcement of access
restrictions associated with changes to the configuration of SQL Server or
database(s)."
...
blocked by access restrictions or changes identified after the fact.
  ...
  desc  'rationale', ''
  desc  'check', "
    Determine if an audit is configured to capture denied actions and started
...
= d.server_specification_id
  ...
  "
  desc  'fix', "
    Add the required events to the server audit specification to audit denied
actions.
    USE [master];
    GO
...
(STATE = ON);
  ...
  tag gid: 'V-213989'
  tag rid: 'SV-213989r508026_rule'
  tag stig_id: 'SQL6-D0-011800'
  tag fix_id: 'F-15204r313751_fix'
  tag cci: ['V-79239', 'SV-93945', 'CCI-001814']
  tag nist: ['CM-5 (1)']
end
