...
control 'V-213981' do
  title "SQL Server must utilize centralized management of the content captured
in audit records generated by all components of SQL Server."
...
well as the backup and archiving of those records.
    ...
    SQL Server may write audit records to database tables, to files in the file
...
off-loaded and how local audit log space is managed.
    ...
    If the SQL Server audit records are not written directly to or
...
centralized log management system."
  ...
  tag gid: 'V-213981'
  tag rid: 'SV-213981r508026_rule'
  tag stig_id: 'SQL6-D0-010700'
  tag fix_id: 'F-15196r313727_fix'
  tag cci: ['SV-93929', 'V-79223', 'CCI-001844']
  tag nist: ['AU-3 (2)']
end
