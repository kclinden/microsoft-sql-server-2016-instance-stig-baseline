...
control 'V-213936' do
  title "SQL Server must be configured to generate audit records for
...
incident or identify those responsible for one.
    ...
    Audit records can be generated from various components within SQL Server
...
auditing.
  ...
  desc  'rationale', ''
  desc  'check', "
    Review the server documentation to determine if any additional events are
required to be audited. If no additional events are required, this is not a
finding.
    ...
    All currently defined audits for the SQL server instance will be listed. If
no audits are returned, this is a finding.
...
= d.server_specification_id
    ...
    Compare the documentation to the list of generated audit events. If there
are any missing events, this is a finding.
  "
  desc  'fix', "Add all required audit events to the STIG Compliant audit
specification server documentation."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000089-DB-000064'
  tag gid: 'V-213936'
  tag rid: 'SV-213936r508026_rule'
