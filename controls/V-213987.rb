...
control 'V-213987' do
  title "SQL Server must enforce access restrictions associated with changes to
...
including upgrades and modifications.
  ...
  desc  'rationale', ''
  desc  'check', "
    Obtain a list of logins who have privileged permissions and role
memberships in SQL.

    Execute the following query to obtain a list of logins and roles and their
respective permissions assignment:
...
sp.grantee_principal_id
    ...
    Execute the following query to obtain a list of logins and their role
memberships.
...
rm.member_principal_id
    ...
    Check the server documentation to verify the logins and roles returned are
authorized. If the logins and/or roles are not documented and authorized, this
is a finding.
  "
  desc  'fix', "
  ...
  tag gid: 'V-213987'
  tag rid: 'SV-213987r508026_rule'
  tag stig_id: 'SQL6-D0-011400'
  tag fix_id: 'F-15202r313745_fix'
  tag cci: ['V-79235', 'SV-93941', 'CCI-001813']
  tag nist: ['CM-5 (1)']
end
