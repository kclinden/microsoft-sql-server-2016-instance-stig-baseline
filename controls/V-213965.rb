...
available configuration parameters or custom code.
  ...
  desc  'check', "
    ...
    If any records are returned. Check the server documentation for a list of
authorized contained database users. Ensure contained database users are not
...
sys.database_principals WHERE authentication_type = 2'
  ...
  "
  desc  'fix', "Configure the SQL Server contained databases to have users
originating from Windows principals. Remove any users not created from Windows
principals."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag gid: 'V-213965'
  tag rid: 'SV-213965r508026_rule'
  tag stig_id: 'SQL6-D0-008000'
  tag fix_id: 'F-15180r313679_fix'
  tag cci: ['V-79193', 'SV-93899', 'CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
