...
is a finding.
  "
  desc  'fix', "Deploy an audit to audit the retrieval of
privilege/permission/role membership information. See the supplemental file
\"SQL 2016 Audit.sql\"."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000091-DB-000325'
  tag gid: 'V-213939'
  tag rid: 'SV-213939r508026_rule'
  tag stig_id: 'SQL6-D0-004600'
  tag fix_id: 'F-15154r313601_fix'
  tag cci: ['SV-93845', 'V-79139', 'CCI-000172']
  tag nist: ['AU-12 c']
end
