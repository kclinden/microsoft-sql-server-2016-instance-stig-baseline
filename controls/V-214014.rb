...
control 'V-214014' do
  title "SQL Server must generate audit records when unsuccessful logons or
...
query.
    ...
    Execute the following query to verify the \"FAILED_LOGIN_GROUP\" is
...
= d.server_specification_id
    ...
    If the \"FAILED_LOGIN_GROUP\" is not returned in an active audit, this is a
finding.
  "
  desc  'fix', "
    Add the \"FAILED_LOGIN_GROUP\" to the server audit specification
    USE [master];
    GO
...
(STATE = ON);
  ...
  tag gid: 'V-214014'
  tag rid: 'SV-214014r508026_rule'
  tag stig_id: 'SQL6-D0-014800'
  tag fix_id: 'F-15229r313826_fix'
  tag cci: ['V-79289', 'SV-93995', 'CCI-000172']
  tag nist: ['AU-12 c']
end
