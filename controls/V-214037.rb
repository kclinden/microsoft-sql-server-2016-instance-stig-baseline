...
control 'V-214037' do
  title "Remote Access feature must be disabled, unless specifically required
and approved."
...
on remote servers or remote stored procedures on local server.  'Remote access'
functionality can be abused to launch a Denial-of-Service (DoS) attack on
remote servers by off-loading query processing to a target.
  "
  desc  'rationale', ''
  desc  'check', "
...
to determine whether the use of \"Remote Access\" is required (linked servers)
...
definitions that are not authorized. To disable the use of \"Remote Access\"
option, from the query prompt: 
  ...
  tag gid: 'V-214037'
  tag rid: 'SV-214037r508026_rule'
  tag stig_id: 'SQL6-D0-017200'
  tag fix_id: 'F-15252r313895_fix'
  tag cci: ['V-79337', 'SV-94043', 'CCI-000381']
  tag nist: ['CM-7 a']
end
