...
control 'V-213950' do
  title "SQL Server must limit privileges to change software modules and links
to software external to SQL Server."
...
library paths on disk.
    ...
    If any unauthorized users are granted modify rights or the owner is
incorrect, this is a finding.

    To determine the location for these instance-specific binaries, Launch SQL
Server Management Studio (SSMS) >> Connect to the instance to be reviewed >>
Right-click server name in Object Explorer >> Click Facets >> Select the Server
facet >> Record the value for the \"RootDirectory\" facet property.

    Navigate to the folder above, and review the \"Binn\" subdirectory.
  "
  desc  'fix', "Change the ownership of all shared software libraries on disk
to the authorized account. Remove any modify permissions granted to
unauthorized users or groups."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000133-DB-000179'
  tag gid: 'V-213950'
  tag rid: 'SV-213950r508026_rule'
  tag stig_id: 'SQL6-D0-006500'
  tag fix_id: 'F-15165r313634_fix'
  tag cci: ['V-79163', 'SV-93869', 'CCI-001499']
  tag nist: ['CM-5 (6)']
end
