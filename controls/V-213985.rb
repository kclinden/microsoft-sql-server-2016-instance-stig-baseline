...
control 'V-213985' do
  title "SQL Server must provide an immediate real-time alert to appropriate
...
in seconds or less). Alerts can be generated using tools like the SQL Server
Agent Alerts and Database Mail.
  "
  desc  'rationale', ''
  desc  'check', "
...
appropriate support staff when an audit log failure occurs."
  ...
  tag gid: 'V-213985'
  tag rid: 'SV-213985r508026_rule'
  tag stig_id: 'SQL6-D0-011100'
  tag fix_id: 'F-15200r495408_fix'
  tag cci: ['V-79231', 'SV-93937', 'CCI-001858']
  tag nist: ['AU-5 (2)']
end
