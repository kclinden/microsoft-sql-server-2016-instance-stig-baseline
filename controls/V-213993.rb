...
control 'V-213993' do
  title "When updates are applied to SQL Server software, any software
...
report\"
    ...
    Compare the feature listing against the required components listing. If any
features are installed, but are not required, this is a finding.
  "
  ...
  tag gid: 'V-213993'
  tag rid: 'SV-213993r508026_rule'
  tag stig_id: 'SQL6-D0-012700'
  tag fix_id: 'F-15208r313763_fix'
  tag cci: ['V-79247', 'SV-93953', 'CCI-002617']
  tag nist: ['SI-2 (6)']
end
